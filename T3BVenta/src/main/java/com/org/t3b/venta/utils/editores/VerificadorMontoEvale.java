 ...
 * @author roberto
 */
public class VerificadorMontoEvale extends InputVerifier{
    ...
    public VerificadorMontoEvale(JLabel p,JLabel c,ConfigV cf,int id,boolean pe){
        this.pagado=p;
        this.cambio=c;
        this.configV=cf;
        this.idPago=id;
    ...
    public boolean verify(JComponent input) {
        VerificadorMontoEvale tmp = new VerificadorMontoEvale(this.pagado,this.cambio,this.configV,this.idPago,this.permiteEscribir);
