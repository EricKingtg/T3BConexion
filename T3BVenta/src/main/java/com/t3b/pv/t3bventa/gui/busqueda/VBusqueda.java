...
public class VBusqueda extends VPantalla implements KeyListener{
    ...
    public void f1Aceptar(){
        ...
        if(itemSeleccionado>=0) {
            ...
            if(controlador.mensajeVistaDecision(this, "¿ Desea Agregar el Articulo ? ","Agregar Articulo")==0){
