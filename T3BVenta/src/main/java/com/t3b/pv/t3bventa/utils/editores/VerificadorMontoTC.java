 ...
 * @author roberto
 */
public class VerificadorMontoTC extends InputVerifier{
    ...
    public VerificadorMontoTC(JLabel p,JLabel c,ConfigV cf,int id,boolean pe){
        this.pagado=p;
        this.cambio=c;
        this.configV=cf;
        this.idPago=id;
    ...
    public boolean verify(JComponent input) {
        VerificadorMontoTC tmp = new VerificadorMontoTC(this.pagado,this.cambio,this.configV,this.idPago,this.permiteEscribir);
