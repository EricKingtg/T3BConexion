...
public class Config {
	...
	public static String nomarch = System.getProperty("user.dir") + File.separator + "config" + File.separator
			+ "t3bframework.properties";
	public static String nomArchLog = System.getProperty("user.dir") + File.separator + "LOG" + File.separator
			+ "T3BFramework.log";
	...
	public static boolean cargaConfig() {
		...
		try {
			...
			Logger3B.Log(1, "T3BCore", "t3b.core.utils.Config", "cargaConfig", ex.getMessage());
			configCargada = false;
		}
		return flag;
	}
	...
	/**
	 * Metodo que devuelve la configuracion para el resto de las
	 * aplicaciones/ventanas requiere tener los campos como cadenas, se llame como
	 * se
	 * 
	 * @param dtoConfig
	 * @return
