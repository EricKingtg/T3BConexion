 ...
 */
package com.t3b.pv.t3bcore.controller;
...
public class ControladorG {
    ...
    public void ejecuta(Object instancia,String accion,String [] parametros){
        ...
        Method metodo = null;  
        try {
            metodo = instancia.getClass().getDeclaredMethod("ejecutaAccion", new Class[]{String.class,String[].class});
...
//String salida = (String)metodo.invoke(instancia, new Object[]{"argumento1"}));  
    ...
    public int tipoVista(){
        ...
        if(desktopSize.height>=600 && desktopSize.width>=800 && desktopSize.height<=768 && desktopSize.width<=1024)
    ...
    public void agregaVista(JInternalFrame vista_tmp,boolean centrado,boolean maximun,boolean cAnterior,boolean cEliminar){
